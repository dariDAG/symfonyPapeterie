 ...
 */
final class Version20220201145846 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles DROP categorie_id, CHANGE libelle libelle VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE code code VARCHAR(25) NOT NULL COLLATE `utf8mb4_unicode_ci`');
